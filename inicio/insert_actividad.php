<?php
	...
	$sql_actividad_comp = 'SELECT * FROM actividad_comp ORDER BY Num_actividad';
				...
				<form method="post" class="col s12">
					...
					<div class="row">
						<div class="input-field col s12">
									<input placeholder="Num de actividad" name="Num_actividad" type="text">
								</div>
						<div class="input-field col s12">
									<input placeholder="Nombre de actividad" name="Nombre_actividad" type="text">
								</div>
